        ...
        stage('Publish to Artifactory') {
            steps {
                ...
                curl -u $ARTIFACTORY_USER:$ARTIFACTORY_PASS \
                    ...
                    "http://172.20.0.32:8081/artifactory/libs-release-local/${REPO}/${BRANCH_NAME}/artifact.zip"
                '''
            }
        }
        ...
        stage('Deploy to Dev') {
            steps {
                ...
                ansible-playbook -i /ansible/inventory.ini /ansible/deploy.yml \
                    -e "artifact_url=http://172.20.0.32:8081/artifactory/libs-release-local/${REPO}/${BRANCH_NAME}/artifact.zip" \
                    --limit dev
                '''
            }
        }
